  ...
  <AppCard class="mb-6">
    <div class="p-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
        <div class="w-full">
          ...
          <div class="relative">
            ...
            <input
              ...
              type="text"
              placeholder="رقم السند، الملاحظات والبيان..."
        ...
        <div class="w-full">
          <h3 class="font-semibold text-sm mb-2 text-text-secondary">نوع الحركة المالية</h3>
          <div class="relative">
            <select
              :value="typeFilter"
            ...
            >
              <option value="">كل المستندات الماليّة</option>
              <option value="journal">قيد يومية عام</option>
              <option value="receipt">سند قبض مالي</option>
              <option value="payment">سند صرف مالي</option>
            </select>
...
defineEmits(['update:searchQuery', 'update:typeFilter'])
</script>
