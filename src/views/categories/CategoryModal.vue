<!--src\views\categories\CategoryModal.vue--->
<template>
  <Transition
...
// تحديد المسمى التفاعلي لعنوان النافذة المنبثقة
const title = computed(() =>
  props.category && props.category.id ? 'تعديل بيانات التصنيف' : 'إضافة تصنيف جديد',
)
