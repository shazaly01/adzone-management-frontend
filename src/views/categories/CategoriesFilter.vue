<!--src\views\categories\CategoriesFilter.vue--->
<template>
  <AppCard class="mb-6">
    <div class="p-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
        <div class="w-full">
          ...
          <div class="relative">
            ...
            <input
              ...
              type="text"
              placeholder="اسم التصنيف أو المسار الكامل..."
        ...
        <div class="w-full">
          <h3 class="font-semibold text-sm mb-2 text-text-secondary">حالة التصنيف</h3>
          <div class="relative">
            <select
              :value="statusFilter"
